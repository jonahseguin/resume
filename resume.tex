...
\section{Skills}
 \resumeSubHeadingListStart
   ...
   \item{
    ...
    \item{
    \textbf{Platforms}{: GitHub, GitLab, GitHub Actions, GitHub Packages, CircleCI, DockerHub, Vercel, CloudFlare, Stripe }
    }
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Akuma Games, LLC.}{}
      {Senior Software Engineer}{Jan 2022 - November 2024}
      \resumeItemListStart
        \item
