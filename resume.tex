...
\section{Skills}
 \resumeSubHeadingListStart
   ...
   \item{
    \textbf{Technologies}{: Node, MongoDB, Redis, MySQL, PostgreSQL, Docker, Kubernetes, Puppeteer }
   }
   \item{
    \textbf{Frameworks}{: React, Next, Vue, Express, Hono, tRPC, Prisma, Drizzle, TanStack, Tailwind, shadcn/ui }
   }
    \item{
    \textbf{Platforms}{: GitHub, Vercel, Cloudflare, Stripe, Twilio, Railway, AWS }
    }
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \item
          {Building AI-powered email to save you time.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Software Developer}{Jan 2022 - Nov 2024}
      \resumeItemListStart
        \item
