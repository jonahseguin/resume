...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \item
          {Increased repeat client bookings by 10\% at a local tattoo studio by developing and shipping a new web application to handle client consultations, custom requests, appointments, artist scheduling and payments.}
        \item
        ...
        \item
          {Improved monthly sales leads by 15\% at a door manufacturing and sales company by shipping a redesigned full-stack web application for the product catalogues with invoices and quotes.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \item
          {Worked closely with team lead to build and test a full-stack web application allowing content creators to purchase licenses for the use of UMG music in videos.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item
          {Migrated the codebase to utilize Continuous Integration and Continuous Deployment, saving up to 1 hour per on-boarding and improving developer experience.}
      \resumeItemListEnd
